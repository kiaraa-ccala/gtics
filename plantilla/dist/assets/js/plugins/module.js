...
var R = {
    ...
    return t.prototype.init = function () {
        ...
        for (var a, o, r, l, d, c = function (t, e, s) {
            var i = t.childNodes ? V(t.childNodes.length, !0) : [], n = e.childNodes ? V(e.childNodes.length, !0) : [],
                a = 0;
...
const F = (t, e, s, {classes: i, format: n, hiddenHeader: a, sortable: o, scrollY: r, type: l}, {
    noColumnWidths: d,
    unhideHeader: h
}) => ({
...
var U = {exports: {}}, W = z(U.exports = function () {
...
}()), J = {exports: {}}, Q = z(J.exports = function () {
    var t = {
            LTS: "h:mm:ss A",
            LT: "h:mm A",
            L: "MM/DD/YYYY",
...
class at {
    ...
    constructor(t, e = {}) {
        ...
        this.options = {
            ...
            labels: n,
            classes: a
        }, this._initialHTML = this.options.destroyable ? s.outerHTML : "", this.options.tabIndex ? this.dom.tabIndex = this.options.tabIndex : this.options.rowNavigation && -1 === this.dom.tabIndex && (this.dom.tabIndex = 0), this._listeners = {onResize: () => this._onResize()}, this._dd = new q(this.options.diffDomOptions || {}), this.initialized = !1, this._events = {}, this._currentPage = 0, this.onFirstPage = !0, this.hasHeadings = !1, this.hasRows = !1, this._searchQueries = [], this.init()
    }
